...
public class DebugUtils {
  ...
  public static void showTransactionStatus(String message) throws InvocationTargetException {
  ...
  public static boolean transactionActive() throws InvocationTargetException {
      try {
  ...
  public static void transactionRequired(String message) throws InvocationTargetException {
